    ...
    <div class="p-8 2xl:px-24 flex justify-between items-center">
      ...
      <div class="md:hidden">
        <div class="text-white">
          <a href="tel:+1 (540) 908-3500">+1 (540) 908-3500</a>
        </div>
      </div>
            ...
            <div class="flex flex-col space-y-4 p-3 mt-10 px-6">
              ...
              <div class="flex space-x-5 items-center">
                <div class="text-xl font-bold text-[white]">
                  <span class="">Follow</span> <span>Us:</span>
                  <div class="border-t-4 border-[#9d0208] w-10"></div>
                </div>
                <div class="facebook">
                  <a href="https://www.facebook.com/americanwebcrafts" target="_blank">
                ...
                <div class="instagram">
                  <a href="https://www.instagram.com/americanwebcrafts" target="_blank">
                ...
                <div class="linkedin">
                  <a href="https://www.linkedin.com/company/american-web-craft" target="_blank">

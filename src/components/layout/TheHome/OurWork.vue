      ...
      <div class="sm:flex">
        <div class="w-full">
          <div class="">
            ...
            <div class="text-center xl:-mt-[5rem] md:-mt-[4rem] sm:-mt-[3rem] -mt-[2rem]">
        ...
        <div class="mt-6">
          ...
          <div class="md:flex sm:py-10 py-6 sm:pb-4 pb-16 items-center md:space-x-4">
...
<script setup>
import OurWorkCarousel from '../UI/OurWorkCarousel.vue';
</script>
<style scoped>

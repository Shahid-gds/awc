<template>
   ...
   const sections = [
     { name: 'HeroBg', class: 'HeroBg', component: defineAsyncComponent(() => import('@/components/layout/ThePackages/Hero.vue')) },
     { name: 'Card', class: 'Card', component: defineAsyncComponent(() => import('@/components/layout/ThePackages/PackagesCard.vue')) },

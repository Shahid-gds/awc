<template>
   ...
   const sections = [
     { name: 'HeroBg', class: 'HeroBg', component: defineAsyncComponent(() => import('@/components/layout/ThePortfolio/Hero.vue')) },
     { name: 'Card', class: 'Card', component: defineAsyncComponent(() => import('@/components/layout/ThePortfolio/Card.vue')) },

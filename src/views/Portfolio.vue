<template>
   ...
   const sections = [
     { name: 'HeroBg', class: 'HeroBg', component: defineAsyncComponent(() => import('@/components/layout/ThePortfolio/Hero.vue').then(m => m.default), { lazy: true }) },
     { name: 'Card', class: 'Card', component: defineAsyncComponent(() => import('@/components/layout/ThePortfolio/Card.vue').then(m => m.default), { lazy: true }) },
   ...
   <style scoped>
   .HeroBg{
     background-image: url('../assets/images/Portfolio/bgs/1stBg.png');
     background-size: 100% 100%;
     background-position: center;
     background-repeat: no-repeat;
   }
   .Card{
     background-image: url('../assets/images/Portfolio/bgs/2ndBg.png');
     background-size: 100% 100%;
     background-position: center;
     background-repeat: no-repeat;
   }
   .ProcessBg{
     background-image: url('../assets/images/Portfolio/bgs/3rdBg.png');
     background-size: 100% 100%;
     background-position: center;
     background-repeat: no-repeat;
   }
   .TestimonialBg{
     background-image: url('../assets/images/Portfolio/bgs/4thBg.png');
     background-size: 100% 100%;
     background-position: center;
     background-repeat: no-repeat;
   }
   .Contact{
     background-image: url('../assets/images/Portfolio/bgs/5thBg.png');
     background-size: 100% 100%;
     background-position: center;
     background-repeat: no-repeat;
   }
